...
const socialLinks = [
  ...
  },
  {
    ...
    icon: (
      ...
      >
        <path
          d="M20.52 3.47A11.4 11.4 0 0 0 12.16 1 11.43 11.43 0 0 0 2 12.44a11.25 11.25 0 0 0 1.6 5.76L2 22l4.96-1.55a11.47 11.47 0 0 0 5.2 1.33h.05a11.39 11.39 0 0 0 8.28-19.31ZM12.17 20.5a9.85 9.85 0 0 1-5-1.34l-.36-.22-3 1 1-3-.23-.37a9.9 9.9 0 1 1 17-5.66 9.9 9.9 0 0 1-9.92 9.6Zm5.45-7.41c-.3-.15-1.78-.87-2.06-.97s-.48-.15-.68.15-.77.97-.95 1.17-.35.23-.65.08a8.18 8.18 0 0 1-2.41-1.47 9 9 0 0 1-1.65-2.03c-.17-.3 0-.46.13-.61.13-.15.3-.38.45-.57.15-.2.2-.34.3-.56s.05-.42-.03-.58-.67-1.61-.92-2.21c-.24-.58-.48-.5-.65-.5h-.54a1 1 0 0 0-.7.34 2.94 2.94 0 0 0-.91 2.2 5.14 5.14 0 0 0 1.1 2.58 12.25 12.25 0 0 0 4.79 4.15c.67.29 1.2.47 1.62.61.68.22 1.3.2 1.8.12.55-.08 1.78-.73 2-1.44s.25-1.32.17-1.44-.3-.23-.6-.38Z"
          fill="currentColor"
        />
      </svg>
    ),
  ...
  return (
    <section id="contact" className="section">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        ...
        <form
          action="https://getform.io/f/bxooqkwa"
          method="POST"
          className="xl:pl-10 2xl:pl-20"
        >
          <div className="md:grid md:items-center md:grid-cols-2 md:gap-2"></div>
          <div className="mb-4">
